    ...
    return (
        <div className="home-section">
                ...
                <main class="col-lg-6">
                    ...
                    <li style={{width:"80%"}} class="stars-active"> <img src={bannerimg} alt=""/> </li>
                ...
                <div class="card">
                    ...
                    <article class="itemside mb-3">
                        <a href="#" class="aside">
                        <img src={bannerimg} width="96" height="96" class="img-md img-thumbnail"/>
                        </a>
                        <div class="info">
