...
export default function EyeShadow() {
   ...
   useEffect(() => {
      const orgNo = window.location.pathname.split('/')[2]
      axios.get("http://localhost:3004/Categories/" + orgNo).then((res) => {
         setProduct(res.data.nested)
      })
   }, [])   
      ...
      <>
         <div class="product_section layout_padding">
            <div class="container">
               <div class="row">
                  <div class="col-sm-12">
                     <h1 class="product_taital">Eye Shadow</h1>
               ...
               <div class="product_section_2 layout_padding">
                  <div class="row">
                     ...
                     {
                        product?.map((res) => (<div class="col-lg-3 col-sm-6" data-bs-toggle="modal" data-bs-target="#exampleModal" onClick={()=>setSingleproduct(res)} >
